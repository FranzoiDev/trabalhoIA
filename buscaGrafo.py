...
class Grafo:
    ...
    def busca_em_profundidade(self, vertice_inicial, vertice_final, acabou=False, visitados=None):
        ...
        for vizinho, _ in self.grafo.get(vertice_inicial, []):
            if vizinho not in visitados:
                self.busca_em_profundidade(vizinho, vertice_final, acabou, visitados)

    def busca_uniforme(self, vertice_inicial, vertice_final):
...
# grafo.busca_em_largura('frankfurt', 'salzburg') # pronto
grafo.busca_em_profundidade('frankfurt', 'basel') # corrigir
# grafo.busca_uniforme('frankfurt', "salzburg") # pronto
...
class Grafo:
    ...
    def busca_em_profundidade(self, vertice_inicial, vertice_final, visitados=None):
        ...
        for vizinho, _ in self.grafo.get(vertice_inicial, []):
            if vizinho not in visitados:
                self.busca_em_profundidade(vizinho, vertice_final, visitados)
...
grafo.busca_em_largura('frankfurt', 'ulm') # pronto
print("-----------------------------------")
grafo.busca_em_profundidade('frankfurt', 'zurich') # pronto
print("-----------------------------------")
grafo.busca_uniforme('frankfurt', "ulm") # pronto
